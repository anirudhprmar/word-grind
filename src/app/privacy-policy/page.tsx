            ...
            <div className="space-y-8 text-gray-700 dark:text-gray-300">
              <section>
                ...
                <p className="leading-relaxed">
                  Welcome to WordGrind (&aposwe,&apos &aposour,&apos or
                  &aposus&apos). We are committed to protecting your personal
                  information and your right to privacy. This Privacy Policy
                  explains how we collect, use, disclose, and safeguard your
                  information when you use our vocabulary learning service.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed">
                      When you use our vocabulary learning features, we store:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                      <li>Words you add to your collection</li>
                      <li>Quiz results and performance data</li>
                      <li>AI conversation history</li>
                      <li>Learning progress and statistics</li>
                      <li>Word definitions, examples, and notes</li>
                    </ul>
                  </div>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>Generate personalized AI conversations for vocabulary practice</li>
                  <li>Process subscription payments and manage billing</li>
                  <li>Send you important updates and notifications</li>
                  <li>Respond to your inquiries and support requests</li>
                  <li>Monitor and analyze usage patterns to improve learning</li>
                  <li>Develop new vocabulary learning features</li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  ...
                  <li>
                    <strong>Polar:</strong> For handling subscription payments and billing
                  </li>
                  <li>
                    <strong>Resend:</strong> For sending magic link emails and notifications
                  </li>
                  <li>
                    <strong>AI Services (Gemini/Mistral):</strong> For generating vocabulary content and conversations
                  </li>
                  <li>
                    <strong>Cloudflare R2:</strong> For storing user-uploaded images
                  </li>
                  <li>
                    <strong>Upstash Redis:</strong> For rate limiting and caching
                  </li>
                </ul>
