            ...
            <div className="space-y-8 text-gray-700 dark:text-gray-300">
              <section>
                ...
                <p className="leading-relaxed">
                  By accessing and using WordGrind (&apos;Service&apos;), you
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  WordGrind provides a comprehensive vocabulary learning platform
                  that helps users expand their vocabulary through interactive
                  features. Our Service includes word collection management,
                  personalized quizzes, AI-powered conversations for vocabulary
                  practice, progress tracking, and subscription-based premium
                  features.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4">
                    ...
                    <li>
                      Create or share vocabulary content that contains false,
              ...
              <section>
                ...
                <div className="space-y-3">
                  ...
                  <p className="leading-relaxed">
                    ...
                    functionality are owned by WordGrind and are protected by
                  ...
                  <p className="leading-relaxed">
                    You retain ownership of any vocabulary content, notes, and
                    personal data you create using our Service. By using our
                    Service, you grant us a worldwide, non-exclusive,
                    royalty-free license to use, reproduce, and display your
                    content solely for the purpose of providing the vocabulary
                    learning Service to you.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed uppercase font-medium">
                  To the maximum extent permitted by law, WordGrind shall not
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  You agree to defend, indemnify, and hold harmless WordGrind
              ...
              <section>
                ...
                <div className="mt-3 space-y-1">
                  ...
                  <p>Website: https://wordgrind.top</p>
                </div>
              </section>

              <section className="pt-8 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  By using WordGrind, you acknowledge that you have read,
